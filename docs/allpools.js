...
TOKENS ={
	250: {
		mc_usdc: {
			...
			s: "mc.USDC",
			d: 6,
			a: "0x04068da6c83afcfa0e13ba15a6696662335d5b75"
		}
	}
};
POOLS = {
...
async function pre_stats() {
	...
	$("250-10-tvl").innerHTML = "$" + Number( ( Number( _gr[15][0] ) / 1e18 * _prices[3] / 300000 + Number( _gr[15][1] ) / 1e18 * _prices[3] ).toFixed() ).toLocaleString();
